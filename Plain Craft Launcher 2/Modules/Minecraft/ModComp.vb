...
#Region "CompFile | 文件信息"
    ...
    Public Class CompFile
        ...
        ''' 文件所有可能的下载源。
        ''' </summary>
        Private ReadOnly DownloadAddress As String()
        ''' <summary>
        ''' 该文件的所有依赖工程的原始 ID。
...
#Region "CurseForge"
                ...
                GameVersions = RawVersions.Where(Function(v) v.StartsWith("1.")).Select(Function(v) v.Replace("-snapshot", " 快照")).ToList
