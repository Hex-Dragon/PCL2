    ...
    Public Property Title As String
        ...
        Set(value As String)
            ...
            Select Case Entry.State
                Case LocalCompFile.McModState.Fine
                    LabTitle.TextDecorations = Nothing
                Case LocalCompFile.McModState.Disabled
                    LabTitle.TextDecorations = TextDecorations.Strikethrough
                Case LocalCompFile.McModState.Unavailable
                    LabTitle.TextDecorations = TextDecorations.Strikethrough
                    value &= " [错误]"
            End Select
            ...
            Try
                ...
                If IsVisibleInForm() Then
                    ...
                    If Checked Then
                        ...
                        Anim.Add(AaColor(LabTitle, TextBlock.ForegroundProperty, If(Entry.State = LocalCompFile.McModState.Fine, "ColorBrush2", "ColorBrush5"), 200))
                    Else
                        '由有变无
                ...
                Else
                    ...
                    If Checked Then
                        RectCheck.Height = 32
                        RectCheck.Opacity = 1
                        LabTitle.SetResourceReference(TextBlock.ForegroundProperty, If(Entry.State = LocalCompFile.McModState.Fine, "ColorBrush2", "ColorBrush5"))
                    Else
                        RectCheck.Height = 0
                        RectCheck.Opacity = 0
                        LabTitle.SetResourceReference(TextBlock.ForegroundProperty, If(Entry.State = LocalCompFile.McModState.Fine, "ColorBrush1", "ColorBrushGray4"))
                    End If
...
#End Region
    ...
    Public Sub Refresh() Handles Me.Loaded
        ...
        Sub()
            ...
            '图标右下角的 Logo
            If Entry.State = LocalCompFile.McModState.Fine Then
