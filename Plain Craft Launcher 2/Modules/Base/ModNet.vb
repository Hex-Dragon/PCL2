...
Capture:
                    ...
                    If TargetUrl.Contains("pcl2-server") OrElse TargetUrl.Contains("gitcode") OrElse TargetUrl.Contains("github.com") OrElse TargetUrl.Contains("modrinth") OrElse TargetUrl.Contains("vip.123pan.cn") Then Return Nothing
                    '寻找最大碎片
