...
#Region "声明"
    ...
    '下列版本信息由更新器自动修改
    Public Const VersionBaseName As String = "2.11.3-beta.2" '不含分支前缀的显示用版本名
    Public Const VersionStandardCode As String = "2.11.3." & VersionBranchCode
    ...
    Public Const VersionCode As Integer = 374 '内部版本号
    '自动生成的版本信息
#If RELEASE Then
