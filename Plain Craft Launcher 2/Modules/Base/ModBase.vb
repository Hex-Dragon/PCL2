    ...
    Public Function GetTimeSpanString(Span As TimeSpan, IsShortForm As Boolean) As String
        ...
        Else
            ...
            ElseIf TotalMonthes >= 1 Then
                '1~4 月，“2 个月 13 天”
                GetTimeSpanString = TotalMonthes & " 个月" & If((Span.Days Mod 30) > 0, " " & (Span.Days Mod 30) & " 天", "")
...
#End If
    ...
    Public Sub Feedback(Optional ShowMsgbox As Boolean = True, Optional ForceOpenLog As Boolean = False)
        ...
        End If
        OpenWebsite("https://github.com/Hex-Dragon/PCL2/issues/new/choose") '修改反馈链接，防止有小白看不懂英文或者不会反馈啥的，更好地反馈bug
    End Sub
