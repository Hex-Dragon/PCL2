...
#Region "声明"
    ...
    Public Const VersionStandardCode As String = "2.10.6." & VersionCodeString '标准格式的四段式版本号
    ...
    Public Const VersionCode As Integer = 366 '内部版本号
    Public Const VersionCodeString As String = "366" '内部版本号的字符串形式
    '自动生成的版本信息
#If RELEASE Then
