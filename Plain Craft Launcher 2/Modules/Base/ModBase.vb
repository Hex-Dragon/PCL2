...
#Region "声明"
    ...
    '下列版本信息由更新器自动修改
    Public Const VersionBaseName As String = "2.8.0" '不含分支前缀的显示用版本名
    Public Const VersionStandardCode As String = "2.8.0." & VersionBranchCode '标准格式的四段式版本号
#If BETA Then
    Public Const VersionCode As Integer = 326 'Release
#Else
    Public Const VersionCode As Integer = 327 'Snapshot
#End If
    '自动生成的版本信息
