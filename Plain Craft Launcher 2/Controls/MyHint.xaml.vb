    ...
    Private Sub SetStyle()
        If Type = HintType.Note Then
            If IsWarn Then
                ...
                Path.Fill = New MyColor(CType(If(IsDarkMode, "#BB980606", "#BF0000"), String))
                LabText.Foreground = New MyColor(CType(If(IsDarkMode, "#BB980606", "#BF0000"), String))
                BtnClose.Foreground = New MyColor(CType(If(IsDarkMode, "#BB980606", "#BF0000"), String))
