...
Public Class MyCard
    ...
    Public Sub New()
        ...
        MainBorder = New Border With {.Background = New SolidColorBrush(Color.FromArgb(IIf(IsDarkMode, 235, 205), IIf(IsDarkMode, 43, 255), IIf(IsDarkMode, 43, 255), IIf(IsDarkMode, 43, 255))), .CornerRadius = New CornerRadius(6), .IsHitTestVisible = False}
    ...
    Private Sub MyCard_MouseEnter(sender As Object, e As MouseEventArgs) Handles Me.MouseEnter
        ...
        AniList.AddRange({
                         ...
                         AaColor(MainBorder, Border.BackgroundProperty, New MyColor(IIf(IsDarkMode, 245, 230), IIf(IsDarkMode, 48, 255), IIf(IsDarkMode, 48, 255), IIf(IsDarkMode, 48, 255)) - MainBorder.Background, 180),
    ...
    Private Sub MyCard_MouseLeave(sender As Object, e As MouseEventArgs) Handles Me.MouseLeave
        ...
        AniList.AddRange({
                         ...
                         AaColor(MainBorder, Border.BackgroundProperty, New MyColor(IIf(IsDarkMode, 235, 205), IIf(IsDarkMode, 43, 255), IIf(IsDarkMode, 43, 255), IIf(IsDarkMode, 43, 255)) - MainBorder.Background, 300),
