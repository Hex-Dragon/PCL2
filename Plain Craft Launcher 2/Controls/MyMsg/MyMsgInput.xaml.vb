Public Class MyMsgInput
    ...
    Public Sub New(Converter As MyMsgBoxConverter)
        Try
            ...
            TextCaption.Text = Converter.Content
            TextCaption.HintText = Converter.HintText
            TextCaption.ValidateRules = Converter.ValidateRules
            ...
            'If Converter.Caption > 0 Then
            '  TextCaption.Focus()
            '  TextCaption.Select(Converter.Caption.Length - 1, 0)
            'End If
    ...
    Public Sub Btn1_Click() Handles Btn1.Click
        If MyConverter.IsExited OrElse Not TextCaption.ValidateResult = "" Then Exit Sub
    ...
    Private Sub TextCaption_ValidateChanged(sender As Object, e As EventArgs) Handles TextCaption.ValidateChanged
        Btn1.IsEnabled = TextCaption.ValidateResult = ""
    End Sub
