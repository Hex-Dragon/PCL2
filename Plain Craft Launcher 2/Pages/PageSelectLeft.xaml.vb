Public Class PageSelectLeft
    ...
    Private Sub McFolderListUI()
        Try
            ...
            '安装按钮
            Dim ItemInstall As New MyListItem With {.IsScaleAnimationEnabled = False, .Type = MyListItem.CheckType.Clickable, .Title = GetLang("LangSelectAddModpackages"), .Height = 34,
                .ToolTip = GetLang("LangSelectAddModpackagesToolTip"),
