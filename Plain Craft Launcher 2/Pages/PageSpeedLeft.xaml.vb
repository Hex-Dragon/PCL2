...
#Region "失败，更新卡片"
                            ...
                            Dim Tb As TextBlock = GetObjectFromXML("<TextBlock xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" TextWrapping=""Wrap"" HorizontalAlignment=""Left"" ToolTip=""{DynamicResource LangSpeedClickCopyError}"" Grid.Column=""1"" Grid.Row=""0"" Margin=""0,0,0,5"" />")
