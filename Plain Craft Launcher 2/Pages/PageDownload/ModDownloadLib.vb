        ...
        Try
            ...
            SyncLock LoaderTaskbarLock
                For i = 0 To LoaderTaskbar.Count - 1
                    If LoaderTaskbar(i).Name = GetLang("LangModDownloadLibTaskMcDownload", Id) Then
...
#Region "OptiFine 下载"
    ...
    Private Sub McDownloadOptiFineSave(DownloadInfo As DlOptiFineListEntry)
        Try
            ...
            SyncLock LoaderTaskbarLock
                For i = 0 To LoaderTaskbar.Count - 1
                    If LoaderTaskbar(i).Name = GetLang("LangModDownloadLibTaskOptiFineDownload", DownloadInfo.NameDisplay) Then
                        Hint(GetLang("LangModDownloadLibHintInstanceDownloading"), HintType.Critical)
                        Exit Sub
                    End If
                Next
...
#Region "LiteLoader 下载"
    ...
    Public Sub McDownloadLiteLoader(DownloadInfo As DlLiteLoaderListEntry)
        Try
            ...
            SyncLock LoaderTaskbarLock
                For i = 0 To LoaderTaskbar.Count - 1
                    If LoaderTaskbar(i).Name = GetLang("LangModDownloadLibTaskLiteLoaderDownload", Id) Then
                        Hint(GetLang("LangModDownloadLibHintInstanceDownloading"), HintType.Critical)
                        Exit Sub
                    End If
                Next
...
#Region "Forgelike 下载"
    ...
    Public Sub McDownloadForgelikeSave(Info As DlForgelikeEntry)
        Try
            ...
            SyncLock LoaderTaskbarLock
                For i = 0 To LoaderTaskbar.Count - 1
                    If LoaderTaskbar(i).Name = GetLang("LangModDownloadLibTaskForgelikeDownload", DisplayName) Then
                        Hint(GetLang("LangModDownloadLibHintInstanceDownloading"), HintType.Critical)
                        Exit Sub
                    End If
                Next
...
#Region "Fabric 下载"
    ...
    Public Sub McDownloadFabricLoaderSave(DownloadInfo As JObject)
        Try
            ...
            SyncLock LoaderTaskbarLock
                For i = 0 To LoaderTaskbar.Count - 1
                    If LoaderTaskbar(i).Name = GetLang("LangModDownloadLibTaskFabricInstallerDownload", Version) Then
                        Hint(GetLang("LangModDownloadLibHintInstanceDownloading"), HintType.Critical)
                        Exit Sub
                    End If
                Next
