    ...
    Private Sub Load_OnFinish()
        ...
        Try
            ...
            For Each Version As String In Versions
                ...
                Dim NewStack As New StackPanel With {.Margin = New Thickness(18, MyCard.SwapedHeight, 18, 15), .VerticalAlignment = VerticalAlignment.Top, .RenderTransform = New TranslateTransform(0, 0), .Tag = Version}
