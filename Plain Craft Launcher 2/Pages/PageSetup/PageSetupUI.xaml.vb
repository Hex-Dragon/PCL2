    ...
    Public Shared Sub HiddenRefresh() Handles Me.Loaded
        ...
        Try
            ...
            Else
                ...
                FrmMain.BtnTitleSelect2.Visibility = If(Not VersionBranchName = "CE", Visibility.Visible, Visibility.Collapsed) 'If(Not HiddenForceShow AndAlso Setup.Get("UiHiddenPageLink"), Visibility.Collapsed, Visibility.Visible)
