Public Class ModSetup
    ...
    Private ReadOnly SetupDict As New Dictionary(Of String, SetupEntry) From {
        ...
        {"DisableAuthHttpWarning", New SetupEntry(False, Source:=SetupSource.Registry)},
        {"DisableAuthWarningBaseUrl", New SetupEntry("", Source:=SetupSource.Registry, Encoded:=True)},
        {"DisableCertCheckWarning", New SetupEntry(False, Source:=SetupSource.Registry)},
