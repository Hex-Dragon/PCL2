Class PageSetupLink
    ...
    End Sub
    Public Sub Reload()
        CheckLinkAuto.Checked = Setup.Get("LinkAuto")
    ...
    '将控件改变路由到设置改变
    Private Shared Sub CheckBoxChange(sender As MyCheckBox, e As Object) Handles CheckLinkAuto.Change
