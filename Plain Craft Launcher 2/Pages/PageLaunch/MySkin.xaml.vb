公共 Class MySkin
    ...
    '事件
    公共 Event Click(sender As Object, e As MouseButtonEventArgs)

    '皮肤储存
    私有 _Address As String
    公共 Property Address As String
        Get
            Return _Address
        End Get
        Set(value As String)
        ...
        End Set
    End Property
    公共 Loader As LoaderTask(Of EqualableList(Of String), String)

    '控件动画
    私有 Sub PanSkin_MouseEnter(sender As Object, e As MouseEventArgs) Handles Me.MouseEnter
        AniStart(AaOpacity(ShadowSkin, 0.8 - ShadowSkin.Opacity, 200， 100), "Skin Shadow")
    End Sub
    私有 Sub PanSkin_MouseLeave(sender As Object, e As MouseEventArgs) Handles Me.MouseLeave
    ...
    '点击
    私有 IsSkinMouseDown As Boolean = False
    私有 Sub PanSkin_MouseLeftButtonDown(sender As Object, e As MouseButtonEventArgs) Handles Me.MouseLeftButtonDown
    ...
    End Sub
    私有 Sub PanSkin_MouseLeftButtonUp(sender As Object, e As MouseButtonEventArgs) Handles Me.MouseLeftButtonUp
        AniStart(AaScaleTransform(Me， 1 - CType(Me.RenderTransform, ScaleTransform).ScaleX, 60,, New AniEaseOutFluent), "Skin Scale")
    ...
    '保存皮肤
    公共 Sub BtnSkinSave_Click() Handles BtnSkinSave.Click
        Save(Loader)
    End Sub
    公共 Shared Sub Save(Loader As LoaderTask(Of EqualableList(Of String), String))
        ...
        End Try
    End Sub
    私有 Sub BtnSkinSave_Checked(sender As MyMenuItem, e As RoutedEventArgs) Handles BtnSkinSave.Checked
    ...
    '刷新缓存
    公共 Sub RefreshClick() Handles BtnSkinRefresh.Click
        RefreshCache(Loader)
    End Sub
    ''' <summary>
    ''' 刷新皮肤缓存。
    ''' </summary>
    公共 Shared Sub RefreshCache(Optional sender As LoaderTask(Of EqualableList(Of String), String) = Nothing)
    ...
    公共 Shared Sub ReloadCache(SkinAddress As String)
        RunInThread(
        Sub()
            Try
                '更新缓存
    ...
    '披风
    公共 Property HasCape As Boolean
        Get
        ...
        End Set
    End Property
    私有 IsChanging As Boolean = False
    公共 Sub BtnSkinCape_Click() Handles BtnSkinCape.Click
        '检查条件，获取新披风
        If IsChanging Then
            Hint("正在更改披风中，请稍候！")
            Exit Sub
                ...
                Sub()
                    Try
                        Dim CapeNames As New Dictionary(Of String， String) From {
                            ...
                            {"Mojang Office"，"Mojang 办公室披风"},{"Home"，"家园披风"},{"Menace"，"威胁披风"}
                        }
