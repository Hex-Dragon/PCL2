Public Class PageVersionScreenshot
    ...
    Public Sub Reload()
        ...
        FileList.RemoveAll(Function(c)
                               ...
                               Dim AllowedSuffix As String() = {".png", ".jpg", ".jpeg", ".bmp", ".tiff"}
        ...
        If FileList.Count > 0 Then
            SetPageButton()
            PanContent.Visibility = Visibility.Collapsed '这行不能删
    ...
    Private Sub LoadImages(Loader As LoaderTask(Of Integer, List(Of MyCard)))
        ...
        For i = StartIndex To EndIndex
            ...
            '    End If
            'End Using
            '由于高清截图模组可以生成不同格式的图片，此处可选支持 WebP 格式图片
    ...
    Private Sub SetPageButton()
        ...
        For i = StartPage To EndPage
            Dim btn = BuildButton(i)
            'btn.SetResourceReference(MyTextButton.ForegroundProperty, "ColorBrush5")
            CardPageBtns.Children.Add(btn)
        Next
