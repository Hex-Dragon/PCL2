...
<<<<<<<< HEAD:Plain Craft Launcher 2/Modules/Minecraft/MyLocalCompItem.xaml.vb
...
>>>>>>>> main:Plain Craft Launcher 2/Pages/PageVersion/MyLocalModItem.xaml.vb
...
<<<<<<<< HEAD:Plain Craft Launcher 2/Modules/Minecraft/MyLocalCompItem.xaml.vb
        If MyMsgBox($"是否要更新 {Entry.Name}？{vbCrLf}{vbCrLf}{GetUpdateCompareDescription()}", "更新确认", "更新", "取消") = 2 Then Return
