...
#Region "初始化"
    ...
    Public Sub PageOther_Loaded() Handles Me.Loaded
        ...
        AddHandler FrmMain.KeyDown, AddressOf PageVersionMod_KeyDown
...
#Region "选择"
    ...
    End Sub
    Private Sub PageVersionMod_KeyDown(sender As Object, e As KeyEventArgs) 'Handles Me.KeyDown 监听自己的事件的话进入页面后不点击右侧控件就没办法监听到事件 (#4311)
        If FrmMain.PageRight IsNot Me Then Exit Sub
